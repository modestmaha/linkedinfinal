				...
				<div id="main" class="no-profile fb-reg">
					...
					<div id="content">
						<div class="register-container">
							<form action="https://www.linkedin.com/reg/join-create" method="POST" name="coldRegistrationForm" novalidate="novalidate" class="standard-form sided " data-jsenabled="check" id="yui-gen2">
								...
								<p class="actions">
									<button class="btn-tertiary" type="submit" id="btn-submit"><div>Join LinkedIn</div></button>*<div class="progress-indicator" >
								</div>
