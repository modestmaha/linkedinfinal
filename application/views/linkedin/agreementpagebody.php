...
<div id="body1" class="" role="main">
  <div class="wrapper hp-nus-wrapper">
    <div id="global-error">
    </div>
    <div id="main2" class="legal">
      <div class="contain">
        <div class="row">
          <div class="header1">
            <div class="row">
              <div class="philosophy user-agreement">
                ...
                <div class="description">
                  ...
                  <div class="row">
                    <div class="text">
                      <p class="first">Welcome, and thanks for using LinkedIn! When you use our products and services, you're agreeing to our terms, so please take a few minutes to read over the User Agreement below.</p>
                      <p>Note: You are entering into a legally binding agreement.</p>
                    </div>
                  </div>
        ...
        <div class="row">
            ...
            <div class="row first">
              ...
              <div class="full-copy">
                <p>
                  ...
                  Our User Agreement has been updated; <a onclick="LI.popup(this.href); return false;" href="agrement.html">click here for a summary of the changes</a>.
          ...
          <div class="back-to-top">
            <a href="#main2">Back to Top<span></span></a>
          </div>
        </div>
        ...
        <div class="row primary-separator">
          <div class="section">
            ...
            <h2 id="your-obligations">2. Your Obligations</h2>

            <div class="row first">
              <h3 class="copy-header">2.1. Applicable laws and this Agreement</h3>
              <div class="brief-copy">
                <p><strong>Some promises you make to us in this Agreement:</strong></p>
              ...
              <div class="full-copy">
                ...
                <ul>
                  <li><a href="agrement.html">DOs and DON'Ts</a>;</li>
                  <li><a href="agrement.html">Complaints Regarding Content Posted on the LinkedIn Website</a>; and</li>
                  <li>
                    <a href="agrement.html">LinkedIn's Privacy Policy</a>.
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div class="row">
              <h3 class="copy-header">2.2. License and warranty for your submissions to LinkedIn</h3>
              <div class="brief-copy">
            ...
            <div class="row">
              <h3 class="copy-header">2.10. User-to-User Communication and Sharing (LinkedIn Groups, Answers, Updates, Company Pages, etc.)
            ...
            <div class="row">
              <h3 class="copy-header">2.11. Privacy</h3>
              <div class="brief-copy">
            ...
            <div class="row">
              <h3 class="copy-header">2.12. Export Control</h3>
              <div class="brief-copy">
            ...
            <div class="row last">
              <h3 class="copy-header">2.13. Contributions to LinkedIn</h3>
              <div class="brief-copy">
        ...
        <div class="row primary-separator">
          <div class="section">
            ...
            <h2 id="our-rights-and-obligations">4. Our Rights &amp; Obligations</h2>

            <div class="row first">
              <h3 class="copy-header">4.1. Services Availability</h3>
              <div class="brief-copy">
                <p>We may change or discontinue Services, and in such case, we do not promise to keep showing or storing your information and materials.</p>
              </div>
              <div class="full-copy">
                <p>For as long as LinkedIn continues to offer the Services, LinkedIn shall provide and seek to update, improve and expand the Services. As a result, we allow you to access LinkedIn as it may exist and be available on any given day and we have no other obligations, except as expressly stated in this Agreement. We may modify, replace, refuse access to, suspend or discontinue LinkedIn, partially or entirely, or change and modify prices prospectively for all or part of the Services for you or for all our Members in our sole discretion. All of these changes shall be effective upon their posting on LinkedIn or by direct communication to you unless otherwise noted. LinkedIn further reserves the right to withhold, remove or discard any content available as part of your account, with or without notice if deemed by LinkedIn to be contrary to this Agreement. For avoidance of doubt, LinkedIn has no obligation to store, maintain or provide you a copy of any content that you or other Members provide when using the Services.</p>
              </div>
            </div>

            <div class="row">
              <h3 class="copy-header">4.2. Third Party Sites and Developers</h3>
              <div class="brief-copy">
            ...
            <div class="row first last">
              ...
              <div class="full-copy">
                ...
                <ul>
                  ...
                  <li>Not apply to any damage that LinkedIn may cause you intentionally or knowingly in violation of this Agreement or applicable law, or as otherwise mandated by applicable law that cannot be disclaimed in this Agreement.</li>
                  <li>Not apply if you have entered into a separate agreement to purchase Premium Services with a separate Limitation of Liability provision that supersedes this section in relation to those Premium Services.</li>
                </ul>
              </div>
            </div>
        ...
        <div class="row primary-separator">
          <div class="section">
            ...
            <div class="row first">
              <h3 class="copy-header">7.1. Mutual rights of termination</h3>
              <div class="brief-copy">
        ...
        <div class="row primary-separator">
          <div class="section">
            ...
            <div class="row first">
              <h3 class="copy-header">8.1. Law and Forum for Legal Disputes</h3>
              <div class="brief-copy">
            ...
            <div class="row last">
              <h3 class="copy-header">8.2. Arbitration Option</h3>
              <div class="brief-copy">
        ...
        <div class="row primary-separator">
          <div class="section">
            ...
            <h2 id="general-terms">9. General Terms</h2>

            <div class="row first">
              <h3 class="copy-header">9.1. Severability</h3>
              <div class="brief-copy">
            ...
            <div class="row">
              <h3 class="copy-header">9.7. No Injunctive Relief</h3>
              <div class="brief-copy">
            ...
            <div class="row">
              <h3 class="copy-header">9.9. Assignment and Delegation</h3>
              <div class="brief-copy">
        ...
        <div class="row primary-separator">
          <div class="section">
            ...
            <h2 id="linkedin-dos-and-donts">10. LinkedIn "DOs" and "DON'Ts."</h2>

            <div class="row first">
              <div class="full-copy-no-brief">
                <p>As a condition to access LinkedIn, you agree to this User Agreement and to strictly observe the following DOs and DON'Ts:</p>
              </div>
            </div>

            <div class="row">
              <h3 class="copy-header">10.1. Do undertake the following:</h3>
              <div class="brief-copy">
                <p>Here's a list of some of the specific things we ask you to do and not do on LinkedIn. If you want a high-level summary of these, please check out our <a href="agrement.html">Professional Community Guidelines</a>.</p>
              </div>
              <div class="full-copy">
                <p>&nbsp;</p>
                <ol>
                  ...
                  <li>
                    Review and comply with our <a href="agrement.html">Privacy Policy</a>;
                  </li>
            ...
            <div class="row last">
              <div class="full-copy-no-brief">
                <h3>10.2. Don't undertake the following:</h3>
                <p>&nbsp;</p>
                <ol>
                  ...
                  <li>Upload, post, email, InMail, transmit or otherwise make available or initiate any content that: <ol>
                  ...
                  <li>Duplicate, license, sublicense, publish, broadcast, transmit, distribute, perform, display, sell, rebrand, or otherwise transfer information found on LinkedIn (excluding content posted by you) except as permitted in this Agreement, <a href="agrement.html">LinkedIn's developer terms and policies</a>, or as expressly authorized by LinkedIn;</li>
                  ...
                  <li>Infringe or use LinkedIn's brand, logos or trademarks, including, without limitation, using the word "LinkedIn" in any business name, email, or URL or including LinkedIn's trademarks and logos except as provided in the <a href="agrement.html">Brand Guidelines</a> or as expressly permitted by LinkedIn;</li>
        ...
        <div class="row primary-separator">
          <div class="section">
            ...
            <h2 id="complaints">11. Complaints Regarding Content Posted on the LinkedIn Website</h2>
        ...
        <div class="row primary-separator" id="how-to-contact-us">
          <div class="contact">
            ...
            <div class="brief-copy">
              ...
              <p>If you have questions or comments about this User Agreement, please contact us <a href="agrement.html">online</a> or by physical mail at:</p>
            </div>
            <div class="us-address">
              <h3>For Members in the United States:</h3>
              <address class="vcard">
                <span class="fn org">LinkedIn Corporation</span>
                <span>Attn: User Agreement Issues</span>
                <div class="adr">
            ...
            <div class="outside-us-address">
              <h3>For Members outside the United States:</h3>
              <address class="vcard">
                <span class="fn org">LinkedIn Ireland Limited</span>
                <span>Attn: User Agreement Issues</span>
                <div class="adr">
                  <span class="street-address">Gardner House, Wilton Place,</span>
                  <div>
                    <span class="locality">Wilton Plaza</span>,
                    <span class="postal-code">Dublin 2</span>
                  </div>
