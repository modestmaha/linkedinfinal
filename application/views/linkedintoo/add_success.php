...
<div id="body" class="globalnav-showStop">
	<div class="wrapper hp-nus-wrapper">
		<div id="global-error">
			 ...
			 <p><strong>Invitation to Umair Ahsan (umair.ahsan.sh@gmail.com) sent.</strong></p>
			 <button class="dismiss" id="global-error-dismiss">Close</button>
			 </div>
			 <script id="controlinit-http-12247-23456647-9" type="text/javascript+initialized" class="li-control">
			 
			 /* extlib: _saveuisetting */
			 
			 
			 
			 LI.Controls.addControl('control-http-12247-23456647-9', 'SaveUISetting', {
